...
$handler->override_option('relationships', array(
  ...
  'content_profile_rel_1' => array(
    'label' => 'Content Profile Lecturer',
    'required' => 0,
    'type' => 'profile',
...
$handler->override_option('fields', array(
  ...
  'field_profile_last_name_value_1' => array(
    ...
    'exclude' => 0,
    'id' => 'field_profile_last_name_value_1',
    'table' => 'node_data_field_profile_last_name',
    'field' => 'field_profile_last_name_value',
  ...
  'field_gradepoint_value' => array(
    ...
    'exclude' => 0,
    'id' => 'field_gradepoint_value',
    'table' => 'node_data_field_gradepoint',
    'field' => 'field_gradepoint_value',
    'relationship' => 'none',
  ),
...
require_once \'./\' . drupal_get_path(\'module\', \'veritas\') . \'/grading/gpa_details_footer.inc\';
?>');
